...
#include "../../../Ventilate/VentilateServer/connectionhandler.h"
...
void ConnectionHandler::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            typedef void (ConnectionHandler::*_t)(QTcpSocket::SocketError );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&ConnectionHandler::error)) {
                *result = 0;
            }
        }
    }
...
const QMetaObject ConnectionHandler::staticMetaObject = {
    { &QThread::staticMetaObject, qt_meta_stringdata_ConnectionHandler.data,
      qt_meta_data_ConnectionHandler,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
// SIGNAL 0
void ConnectionHandler::error(QTcpSocket::SocketError _t1)
{
